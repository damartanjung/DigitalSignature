...
$p12File = file_get_contents('Faqrul.p12');
$certificate = file_get_contents('Faqrul.crt');
openssl_pkcs12_read($p12File, $certs, 'XrfJ5j');
...
$pdf->setSignature($certificate, $certs['pkey'], 'XrfJ5j', '', 2, $info);
